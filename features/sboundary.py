...
def sboundary__load_config_verify():
    ...
    if c.sboundary__max != 0:
        if c.sboundary__max < 0:
            LOG_ERROR('<sboundary__max> value <{0}> is invalid. Maximum price boundary must be positive number'.format(c.sboundary__max))
            error_num += 1
        
    if c.sboundary__min != 0:
        if c.sboundary__min < 0:
            LOG_ERROR('<sboundary__min> value <{0}> is invalid. Minimum price boundary must be positive number'.format(c.sboundary__min))
            error_num += 1
        
    if c.sboundary__max < c.sboundary__min:
        LOG_ERROR('<sboundary__max> value <{0}> can not be less than <sboundary__min> value <{1}>.'.format(c.sboundary__max, c.sboundary__min))
        error_num += 1
    
    return error_num, crazy_num

def sboundary__get_price_cb__(maker, taker):
    LOG_ERROR('dexbot.features.sboundary.sboundary__get_price_cb__() function is just empty default callback, please replace with pricing_storage__try_get_price')
    return 0
...
def sboundary__pricing_init(maker, taker, action, get_price_fn = sboundary__get_price_cb__):
    ...
    LOG_DEBUG('pricing init >> started >> {}/{}'.format(d.sboundary__maker, d.sboundary__taker))
    ...
    if action == 'restore':
        ...
        if price_initial != None and price_current != None:
            ...
            LOG_INFO('pricing init >> restore from tmp cfg >> price initial/current {}/{} >> success'.format(d.sboundary__price_initial, d.sboundary__price_current))
        # if pricing restore failed, then run normal pricing init
        else:
            LOG_WARNING('pricing init >> restore from tmp cfg >> price initial/current {}/{} >> failed'.format(price_initial, price_current))
    ...
    if d.sboundary__price_initial == 0:
        if c.sboundary__price_reverse is False:
            LOG_ACTION('pricing init >> trying to initialize not reversed price')
            ...
            if d.sboundary__price_initial != 0:
                ...
                LOG_INFO('pricing init >> not restore >> not reversed >> maker/asset/taker {}/{}/{} price initial/current {}/{} >> success'.format(maker, c.sboundary__asset, taker, d.sboundary__price_initial, d.sboundary__price_current))
            else:
                LOG_ERROR('pricing init >> not restore >> not reversed >> maker/asset/taker {}/{}/{} price initial/current {}/{} >> failed'.format(maker, c.sboundary__asset, taker, d.sboundary__price_initial, d.sboundary__price_current))
        else:
            LOG_ACTION('pricing init >> trying to initialize reversed price')
            ...
            if tmp_price != 0:
                ...
                if d.sboundary__price_initial != 0:
                    ...
                    feature__tmp_cfg__set_value(d.sboundary__id_price_initial, d.sboundary__price_initial, True)
                    LOG_INFO('pricing init >> not restore >> reversed >> maker/asset/taker {}/{}/{} price initial/current {}/{} >> success'.format(maker, c.sboundary__asset, taker, d.sboundary__price_initial, d.sboundary__price_current))
                else:
                    LOG_ERROR('pricing init >> not restore >> reversed >> maker/asset/taker {}/{}/{} price initial/current {}/{} >> failed'.format(maker, c.sboundary__asset, taker, d.sboundary__price_initial, d.sboundary__price_current))
            else:
                LOG_ERROR('pricing init >> not restore >> reversed >> maker/asset/taker {}/{}/{} price initial/current {}/{} >> failed to reverse pricing'.format(maker, c.sboundary__asset, taker, d.sboundary__price_initial, d.sboundary__price_current))
...
def sboundary__pricing_update():
    ...
    if c.sboundary__max_track_asset is True or c.sboundary__min_track_asset is True or d.sboundary__price_current == 0:
        ...
        if tmp_sboundary__price_current != 0:
            ...
            LOG_INFO("pricing update >> <{}/{}>: <{}> >> success".format(c.sboundary__asset, d.sboundary__taker, tmp_sboundary__price_current))
        else:
            LOG_ERROR("pricing update >> <{}/{}>: <{}> >> failed".format(c.sboundary__asset, d.sboundary__taker, tmp_sboundary__price_current))
    else:
...
def sboundary__get_max__():
    ...
    if c.sboundary__max != 0:
        ...
        if c.sboundary__max_track_asset is False:
            ...
            LOG_DEBUG("get maximum >> track no >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * max(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_initial, c.sboundary__max, maximum))
        else:
            maximum = d.sboundary__price_current * c.sboundary__max
            LOG_DEBUG("get maximum >> track yes >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * max(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_current, c.sboundary__max, maximum))
...
def sboundary__get_min__():
    ...
    if c.sboundary__min != 0:
        ...
        if c.sboundary__min_track_asset is False:
            ...
            LOG_DEBUG("get minimum >> track no >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * min(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_initial, c.sboundary__min, minimum))
        else:
            minimum = d.sboundary__price_current * c.sboundary__min
            LOG_DEBUG("get minimum >> track yes >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * min(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_current, c.sboundary__min, minimum))
...
def sboundary__check_max(price):
    ...
    if c.sboundary__max != 0:
        ...
        if maximum < price:
            LOG_ACTION('Maximum cfg <{}:{}> for <{}/{}> price {} hit maximum {}'.format(c.sboundary__asset, c.sboundary__max, d.sboundary__maker, d.sboundary__taker, price, maximum))
...
def sboundary__check_min(price):
    ...
    if c.sboundary__min != 0:
        ...
        if minimum > price:
            LOG_ACTION('Minimum cfg <{}:{}> for <{}/{}> price {} hit minimum {}'.format(c.sboundary__asset, c.sboundary__min, d.sboundary__maker, d.sboundary__taker, price, minimum))
