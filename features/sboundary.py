...
def sboundary__pricing_init(maker, taker, action, get_price_fn = sboundary__get_price_cb__):
    ...
    if action == 'restore':
        ...
        # if pricing restore failed, then run normal pricing init
            ...
            print('**** WARNING sboundary >> pricing init >> restore from tmp cfg >> price initial/current {}/{} >> failed'.format(price_initial, price_current))
...
def sboundary__get_max__():
    ...
    if c.sboundary__max != 0:
        ...
        if c.sboundary__max_track_asset is False:
            ...
            print("---- DEBUG  sboundary >> get maximum >> track no >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * max(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_initial, c.sboundary__max, maximum))
        else:
            maximum = d.sboundary__price_current * c.sboundary__max
            print("---- DEBUG  sboundary >> get maximum >> track yes >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * max(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_current, c.sboundary__max, maximum))
...
def sboundary__get_min__():
    ...
    if c.sboundary__min != 0:
        ...
        if c.sboundary__min_track_asset is False:
            ...
            print("---- DEBUG  sboundary >> get minimum >> track no >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * min(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_initial, c.sboundary__min, minimum))
        else:
            minimum = d.sboundary__price_current * c.sboundary__min
            print("---- DEBUG  sboundary >> get minimum >> track yes >> maker/asset/taker {}/{}/{} >> price initial(price of asset) * min(set in asset) = final >> {} * {} = {}".format(d.sboundary__maker, c.sboundary__asset, d.sboundary__taker, d.sboundary__price_current, c.sboundary__min, minimum))
